...
Cylinder cylinder1(1.0f, 1.0f, 2.0f, 36, 8, false, 2); // baseRadius, topRadius, height, sectors, stacks, flat shading, up-axis=Y(2)
Cylinder cylinder2(1.0f, 1.0f, 2.0f, 36, 8, true, 2);  // baseRadius, topRadius, height, sectors, stacks, smooth(default), up-axis=Y(2)
...
bool initSharedMem()
{
    ...
    cylinder1.setUpAxis(2);     // Y axis up
    cylinder2.setUpAxis(2);     // Y axis up
    cylinder2.printSelf();
